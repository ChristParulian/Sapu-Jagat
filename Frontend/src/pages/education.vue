<template>
  <div class="min-h-screen flex flex-col justify-between bg-[#FEFAE0] font-['Montserrat','Open Sans',sans-serif]">
    ...
    <div class="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 pt-20 lg:pt-24 xl:pt-28 pb-8">
      ...
      <div class="glass-card p-8 relative overflow-hidden mb-8" data-aos="zoom-in" data-aos-delay="200">
        ...
        <div class="relative z-10">
          <div class="text-center mb-8">
            ...
            <h2 class="text-2xl sm:text-3xl font-bold text-brand-forest mb-4">Edukasi Pengelolaan Sampah</h2>
            <p class="text-brand-forest/70 text-lg">Mari pelajari cara mengelola sampah dengan benar!</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="modern-card p-6 relative overflow-hidden cursor-pointer bg-gradient-to-br from-blue-50 to-blue-100">
              <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full blur-xl"></div>
              <div class="relative z-10">
                <div class="flex items-center mb-3">
          ...
          <!-- Dampak Section -->
          <div class="modern-card bg-gradient-to-br from-brand-cream to-white p-6 mb-8 relative overflow-hidden" data-aos="fade-up">
          ...
          <div class="mb-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div class="modern-card p-5 bg-gradient-to-br from-white to-brand-cream/50">
                ...
                <p class="text-sm text-brand-forest/70">Bersihkan, keringkan, dan serahkan ke bank sampah atau tempat daur ulang.</p>
              </div>
              <div class="modern-card p-5 bg-gradient-to-br from-white to-brand-cream/50">
                <div class="flex items-center mb-3">
                  <div class="w-8 h-8 bg-brand-sage/10 rounded-full flex items-center justify-center">
                ...
                <p class="text-sm text-brand-forest/70">Pisahkan dari sampah basah, ikat, dan jual ke pengepul atau didaur ulang jadi kertas baru.</p>
              </div>
              <div class="modern-card p-5 bg-gradient-to-br from-white to-brand-cream/50">
                <div class="flex items-center mb-3">
                  <div class="w-8 h-8 bg-brand-sage/10 rounded-full flex items-center justify-center">
                ...
                <p class="text-sm text-brand-forest/70">Kumpulkan pecahan kaca dengan aman. Gunakan wadah tertutup agar tidak melukai orang lain.</p>
              </div>
              <div class="modern-card p-5 bg-gradient-to-br from-white to-brand-cream/50">
                <div class="flex items-center mb-3">
                  <div class="w-8 h-8 bg-brand-sage/10 rounded-full flex items-center justify-center">
                ...
                <p class="text-sm text-brand-forest/70">Jadikan kompos menggunakan metode takakura, keranjang kompos, atau biopori.</p>
              </div>
            </div>
          </div>
    ...
    <!-- Toast Notification -->
    <div v-if="toastMsg" :class="`fixed bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-lg shadow-lg text-sm sm:text-base transition-all duration-300 ease-in-out z-50 ${toastType === 'success' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`" class="pointer-events-auto">
      {{ toastMsg }}
    </div>
  </div>
</template>
...
async function confirmEndQuiz() {
  ...
  try {
    ...
    const res = await axios.post(`${import.meta.env.VITE_API_URL}/quiz/submit`, { quiz_id: currentQuiz.value }, {
      headers: { Authorization: `Bearer ${token.value}` }
    });
    if (res.data.status === 'success') {
    ...
    toastMsg.value = err?.response?.data?.message || err.message || 'Gagal submit kuis';
    toastType.value = 'error';
  } finally {
