<template>
  ...
  >
    ...
    <div class="flex-1 main-content pt-24 lg:pt-28 xl:pt-32 p-4 sm:p-8">
      ...
      >
        ...
        <div class="flex-1" data-aos="fade-right">
          ...
          >
            ...
            <span style="color: #a4b465">{{
              userProfile?.username || "User"
            }}</span
            >!
          </h1>
          <p class="text-lg mb-6" style="color: #626f47">
        ...
        <div class="flex-1 flex justify-center items-center" data-aos="zoom-in">
          <div class="relative w-full max-w-xs md:max-w-md lg:max-w-lg">
            <img
              src="/illustrations/illustrasi3.png"
              alt="Ilustrasi edukasi daur ulang sampah"
              class="w-full drop-shadow-2xl rounded-3xl p-0 bg-white/0"
              style="object-fit: contain; background: none"
            />
            <div
              class="absolute bottom-2 left-2 text-xs px-2 py-1 rounded credit-text"
              style="font-size: 11px; pointer-events: auto"
            >
              <a
                href="http://www.freepik.com"
                target="_blank"
                rel="noopener"
                style="color: #a4b465; text-decoration: underline"
          ...
          <div
            ...
            style="
              background: linear-gradient(
                135deg,
                rgba(255, 207, 80, 0.3),
                rgba(164, 180, 101, 0.3)
              );
            "
          ></div>
          <div
            class="absolute bottom-0 left-0 w-24 h-24 rounded-full blur-2xl"
            style="
              background: linear-gradient(
                45deg,
                rgba(164, 180, 101, 0.2),
                rgba(98, 111, 71, 0.2)
              );
            "
          ></div>
          ...
          <div class="relative z-10">
            <div class="text-center mb-8">
              <div
                ...
                style="background: linear-gradient(135deg, #ffcf50, #a4b465)"
              >
                <!-- Bar chart icon -->
                <svg
              ...
              <h3
                class="text-2xl font-bold mb-2 bg-gradient-to-r bg-clip-text text-transparent"
                style="
                  background-image: linear-gradient(135deg, #626f47, #a4b465);
                "
              >
                Statistik Total Sampah Yang Sudah Di Scan
              </h3>
              <p class="text-sm" style="color: #626f47">
                Data statistik sampah yang sudah di scan oleh anda tiap harinya!
              </p>
            </div>

            <div
              class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/30"
            >
      ...
      <div
        class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 w-full px-0 -mx-4 sm:mx-0"
        data-aos="fade-up"
        data-aos-delay="100"
      >
        <!-- Card Jagat Aktif -->
        <div
          class="group modern-card p-6 relative overflow-hidden"
          style="background: linear-gradient(135deg, #a4b465, #626f47)"
        >
          <div
        ...
        <!-- Card Profil Jagat -->
        <div
          class="group modern-card p-6 relative overflow-hidden cursor-pointer"
          @click="goToProfile"
          style="background: linear-gradient(135deg, #ffcf50, #a4b465)"
        >
          <div
          ...
          >
            <div
              class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300"
            >
              <svg
        ...
        <div
          class="group modern-card p-6 relative overflow-hidden cursor-pointer"
          @click="goToHistory"
          style="background: linear-gradient(135deg, #626f47, #a4b465)"
        >
          <div
            class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full blur-xl"
          ></div>
      ...
      <div class="mb-8" data-aos="fade-up" data-aos-delay="200">
        <div class="glass-card p-8 relative overflow-hidden">
          <div
            class="absolute top-0 left-0 w-28 h-28 rounded-full blur-2xl"
            style="
              background: linear-gradient(
                135deg,
                rgba(164, 180, 101, 0.2),
          ...
          <div class="relative z-10">
            ...
            <div
              class="bg-white/70 backdrop-blur-sm rounded-2xl p-2 shadow-xl border border-white/20"
            >
              <div
                id="map"
...
onMounted(async () => {
  ...
  try {
    ...
    const res = await fetch(
      "https://api.maptiler.com/data/01974e93-88e2-7375-a40e-2a1dc2e1c474/features.json?key=OCxf3aKSk6gkj1aQKlOR",
    );
    const data = await res.json();
      ...
      data.features.forEach((f) => {
        ...
        if (
          ...
          if (
            ...
            if (alamat)
              popupContent += `<br><span style='font-size:13px;'>${alamat}</span>`;
            if (deskripsi)
              popupContent += `<br><span style='font-size:12px;color:#888;'>${deskripsi}</span>`;
