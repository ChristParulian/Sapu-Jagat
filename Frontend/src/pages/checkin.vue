<template>
  <div class="min-h-screen flex flex-col items-center bg-bg pt-28 lg:pt-32" style="font-family: 'Montserrat', 'Open Sans', sans-serif;">
    <!-- Header Component -->
    <Header />
    <div class="w-full max-w-5xl p-2 sm:p-4 md:p-8 mt-2 sm:mt-4 mb-20 mx-1 sm:mx-4 bg-white rounded-2xl shadow-lg border-2 border-secondary">      <div class="flex flex-col sm:flex-row items-center justify-between mb-4 gap-2">
      ...
      </div>      <div class="overflow-x-auto -mx-1 sm:mx-0">
